...
class Car:
	...
	# - Accel limit is when the acceleration of the car is the
	# limiting factor for velocity.
	# - Brake limit is when the braking of the car is the limiting 
	# factor for velocity.
	# - Brake limit is ignored by the leading vehicle.
